...
```
##### Visualize the Yearly GDP Change for each state 
...
##### Visualize the 2019 Percent Change in GDP for every state
```{r echo=FALSE}
label_2019 <- paste0(
...
##### Visualize the 2020 Percent Change in GDP for every state
```{r echo=FALSE}
label_2020 <- paste0(
...
##### Visualize the Percent Change in GDP for every state by Industry
```{r echo=FALSE}
